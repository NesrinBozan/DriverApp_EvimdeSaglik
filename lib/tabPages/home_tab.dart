...
import 'package:saglik_kapimda/main.dart';
import 'package:saglik_kapimda/push_notifications/push_notification_system.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        //buttom for online offlin driver
        Positioned(
                      ...
                      if(isDriverActive != true)// offline
                       {
                        ...
                        Fluttertoast.showToast(msg: "Şuan Çevrimiçisin");
                       }
                      else
                        {
                          driverIsOffLineNow();
                          ...
                          Fluttertoast.showToast(msg: "Şuan Çevrimdışısın");
                        }
                    },
